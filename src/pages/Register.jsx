        ...
        <div className="auth-page">
            ...
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; }
                ...
                .auth-tagline { font-size: 0.78rem; font-weight: 400; color: #94a3b8; margin: 0; letter-spacing: 0.2px; }
                ...
                .auth-title {
                    font-size: 1rem; font-weight: 700; color: #0d1f4f;
                    margin: 0 0 1.75rem; line-height: 1.4; letter-spacing: -0.15px;
                }
