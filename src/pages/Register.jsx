...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Show toast then redirect to login after 2.5 seconds
            setToast(true);
            setTimeout(() => {
                navigate('/login');
            }, 2500);
    ...
    return (
        <div className="auth-page">
            ...
            <div className="auth-card">
                ...
                <h6 className="auth-title">Create your account</h6>
            ...
            <style>{`
                ...
                .auth-back a { font-size: 0.82rem; color: #6b7a99; text-decoration: none; }
