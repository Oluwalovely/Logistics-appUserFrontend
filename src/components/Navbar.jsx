...
import { LayoutDashboard, PlusCircle, Bell, LogOut, Menu, X } from 'lucide-react';
            ...
            <nav className="app-nav">
                <div className="app-nav-inner">
                    ...
                    <div className="app-nav-links">
                        ...
                        <Link to="/create-order" className={`app-nav-link ${isActive('/create-order') ? 'active' : ''}`}>
                ...
                {menuOpen && (
                    <div className="app-mobile-menu">
                        ...
                        <Link to="/create-order" className={`app-mobile-link ${isActive('/create-order') ? 'active' : ''}`}>
                            <PlusCircle size={16} /> New Order
                        </Link>
